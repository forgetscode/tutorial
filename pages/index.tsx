...
export default function Home() {
  return (
    <div className="w-screen">
      ...
      <SideBar title = "Your Name" footer="Your name" props = 
        {
          [
      ...
      />
      <div id ="Home" className='flex h-screen w-full bg-black justify-center items-center text-white text-2xl'>Help</div>
